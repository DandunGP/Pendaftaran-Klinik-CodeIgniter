...
class Model_Tampil extends CI_Model
{
    ...
    public function tampil_daftar_pasien_jalan()
    {
        return $this->db->get('tb_daftar_pasien_jalan')->result_array();
    }
    public function tampil_daftar_pasien_ugd()
    {
        return $this->db->get('tb_daftar_pasien_ugd')->result_array();
    }
