        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <?php
                $queri = $this->db->get_where('tb_daftar_pasien_ugd', ['id_detail_pasien' => $id])->row_array();
                ?>
            </div>

            <div class="card">
                <div class="alert bg-success" role="alert">
                    <h4 class="text-center text-light">Edit Form UGD</h4>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= base_url('admin/update_ugd'); ?>">
                        <div class="form-row">
