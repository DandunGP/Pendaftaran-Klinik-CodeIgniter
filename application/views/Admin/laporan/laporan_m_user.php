...
$pdf->Cell(0,7,'Laporan User',0,1,'C');
...
foreach ($user as $data){
    $pdf->Cell(8,6,$no,1,0);
    $pdf->Cell(35,6,$data['nama_u'],1,0,'C');
    $pdf->Cell(20,6,$data['jenis_kelamin_u'],1,0,'C');
    $pdf->Cell(30,6,$data['tanggal_lahir_u'],1,0,'C');
    $pdf->Cell(30,6,$data['notelp_u'],1,0,'C');
    $pdf->Cell(30,6,$data['jabatan_u'],1,0,'C');
    $pdf->Cell(35,6,$data['username'],1,1,'C');
    $no++;
}
$pdf->Output();
?>