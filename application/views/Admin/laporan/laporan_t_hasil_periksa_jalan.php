...
$pdf->Cell(0, 7, 'Laporan Pendaftaran Rawat Jalan', 0, 1, 'C');
...
<tr>
    ...
    <th valign="middle" style="width:60px;text-align:center;"><b>Kode Pasien</b></th>
    <th valign="middle" style="width:70px;text-align:center;"><b>Nama Pasien</b></th>
    <th valign="middle" style="width:80px;text-align:center;"><b>Keluhan</b></th>
    <th valign="middle" style="width:60px;text-align:center;"><b>Poli</b></th>
    <th valign="middle" style="width:70px;text-align:center;"><b>Dokter</b></th>
    <th valign="middle" style="width:54px;text-align:center;"><b>Tanggal</b></th>
...
foreach ($detail_pasien as $data) {
    $tbl .= '<tr>';
    $query = $this->db->query("SELECT * FROM tb_pasien WHERE kib = '" . $data['kib'] . "' ")->row_array();
    $query2 = $this->db->query("SELECT * FROM tb_spesialis WHERE id_spesialis = '" . $data['id_spesialis'] . "' ")->row_array();
    ...
    $tbl .= '<td style="text-align:center;">' . $query2['nama_spesialis'] . '</td>';
